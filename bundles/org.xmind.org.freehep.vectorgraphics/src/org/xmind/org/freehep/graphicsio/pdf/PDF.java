...
public class PDF {
    ...
    // PDFRefs stored by name
    private Hashtable<String, PDFRef> refsByName = new Hashtable<String, PDFRef>();

    // PDFRefs stored by number
    private Vector<PDFRef> refsByNumber = new Vector<PDFRef>();

    // Offsets stored by refnumber
    private Vector<Integer> xrefsByNumber = new Vector<Integer>();
