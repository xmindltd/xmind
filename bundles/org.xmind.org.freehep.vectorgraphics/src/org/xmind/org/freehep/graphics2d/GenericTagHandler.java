...
public class GenericTagHandler extends TagHandler {
     ...
     * @param y
     *            coordinate for drawing
     * @param superscriptCorrection
     *            correction for to high / to low text
     */
    public void print(TagString s, double x, double y,
            double superscriptCorrection) {

        fontFamilyStack = new Stack<String>();
        ...
        AttributedString attributedString = new AttributedString(
                clearedText.toString(), FontUtilities.getAttributes(graphics
                        .getFont()));
    ...
    /**
     * closes the given html tag. It doesn't matter, if that one was opened, so
     * </udot> closes a <udash> too, because the use the same
    ...
    protected String closeTag(String tag) {
        ...
        if (tag.equalsIgnoreCase("b")) {
            ...
            this.attributes
                    .add(new AttributeEntry(begin, clearedText.length(),
