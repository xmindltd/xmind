...
public abstract class VectorGraphics extends Graphics2D implements
    ...
    /**
     * Fills an are with the given paint using in offscreen BufferedImage. Used
     * for drawing GradientPaint or image
     *
     * @param shape
     *            Shape usede as clipping area
     * @param paint
     *            Paint used
     */
    protected void fill(Shape shape, Paint paint) {
        ...
        // create image
        BufferedImage image = new BufferedImage((int) Math.ceil(bounds
                .getWidth()) + 1, (int) Math.ceil(bounds.getHeight()) + 1,
    ...
    static {
        symbols.put("vline", new Integer(SYMBOL_VLINE)); //$NON-NLS-1$
        symbols.put("hline", new Integer(SYMBOL_HLINE)); //$NON-NLS-1$
        symbols.put("plus", new Integer(SYMBOL_PLUS)); //$NON-NLS-1$
        symbols.put("cross", new Integer(SYMBOL_CROSS)); //$NON-NLS-1$
        symbols.put("star", new Integer(SYMBOL_STAR)); //$NON-NLS-1$
        symbols.put("circle", new Integer(SYMBOL_CIRCLE)); //$NON-NLS-1$
        symbols.put("box", new Integer(SYMBOL_BOX)); //$NON-NLS-1$
        symbols.put("up_triangle", new Integer(SYMBOL_UP_TRIANGLE)); //$NON-NLS-1$
        symbols.put("dn_triangle", new Integer(SYMBOL_DN_TRIANGLE)); //$NON-NLS-1$
        symbols.put("diamond", new Integer(SYMBOL_DIAMOND)); //$NON-NLS-1$
    }
    ...
    static {
        alignments.put("baseline", new Integer(TEXT_BASELINE)); //$NON-NLS-1$
        alignments.put("left", new Integer(TEXT_LEFT)); //$NON-NLS-1$
        alignments.put("top", new Integer(TEXT_TOP)); //$NON-NLS-1$
        alignments.put("middle", new Integer(TEXT_CENTER)); //$NON-NLS-1$
        alignments.put("center", new Integer(TEXT_CENTER)); //$NON-NLS-1$
        alignments.put("right", new Integer(TEXT_RIGHT)); //$NON-NLS-1$
        alignments.put("bottom", new Integer(TEXT_BOTTOM)); //$NON-NLS-1$
    }
