...
import org.xmind.ui.internal.spreadsheet.decorations.SpreadsheetBranchDecoration2.Block;
import org.xmind.ui.mindmap.IBranchPart;
import org.xmind.ui.util.MindMapUtils;

public class ColumnHeadTopicDecoration extends HeadTopicDecoration {

    private IGraphicalPart part;

    public ColumnHeadTopicDecoration(String id, IGraphicalPart part) {
        setId(id);
        this.part = part;
    }
    ...
    private Block findBlock(IBranchPart branch, IFigure parentBranchFigure) {
        if (parentBranchFigure instanceof IDecoratedFigure) {
            IDecoration parentDecoration = ((IDecoratedFigure) parentBranchFigure)
                    .getDecoration();
            if (parentDecoration instanceof SpreadsheetBranchDecoration2) {
                SpreadsheetBranchDecoration2 chartDecoration = (SpreadsheetBranchDecoration2) parentDecoration;
