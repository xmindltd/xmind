...
public class RowHead implements Comparable<RowHead> {

    private static final Collection<String> EMPTY_LABELS = Collections
            .emptyList();

    public static final RowHead EMPTY = new RowHead(EMPTY_LABELS);
    ...
    public RowHead(Collection<String> labels) {
        this.labels = new TreeSet<String>(labels);
    }

    public RowHead(String text) {
    ...
    public boolean equals(Object obj) {
        if (obj == this)
            return true;
        if (obj == null || !(obj instanceof RowHead))
            return false;
        RowHead that = (RowHead) obj;
    ...
    public int compareTo(RowHead o) {
